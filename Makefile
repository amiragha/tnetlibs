...
SRCS=Tensor.cpp Index.cpp  ternaryMera.cpp iDMRG.cpp IDMRGS.cpp
...
libidmrg.so: Tensor.o Index.o  iDMRG.o IDMRGS.o
	$(CXX) -shared -o libidmrg.so Tensor.o Index.o iDMRG.o IDMRGS.o $(LDLIBS)
